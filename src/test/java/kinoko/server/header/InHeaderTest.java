...
public enum InHeaderTest {
    ...
    private static final List<InHeaderTest> headers;
    private static final Set<InHeaderTest> ignoreHeaders = Set.of(
    ...
    static {
        final List<InHeaderTest> headerList = new ArrayList<>(Collections.nCopies(NO.getValue() + 1, null));
        for (InHeaderTest header : values()) {
    ...
    public static InHeaderTest getByValue(short op) {
