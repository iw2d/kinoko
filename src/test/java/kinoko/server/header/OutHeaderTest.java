...
public enum OutHeaderTest {
    ...
    private static final List<OutHeaderTest> headers;
    private static final Set<OutHeaderTest> ignoreHeaders = Set.of(
            CharacterInfo,
            PartyResult,
            SetField,
            SetCashShop,
    ...
    static {
        final List<OutHeaderTest> headerList = new ArrayList<>(Collections.nCopies(NO.getValue() + 1, null));
        for (OutHeaderTest header : values()) {
    ...
    public static OutHeaderTest getByValue(short op) {
