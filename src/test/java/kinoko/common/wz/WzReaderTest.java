...
public class WzReaderTest {
    ...
    public void testTamingMob() {
        readWzFile("TamingMob_GMS_75.wz", GameConstants.WZ_GMS_IV, 75);
        readWzFile("TamingMob_GMS_87.wz", GameConstants.WZ_GMS_IV, 87);
        readWzFile("TamingMob_GMS_95.wz", GameConstants.WZ_GMS_IV, 95);
        readWzFile("TamingMob_GMS_146.wz", GameConstants.WZ_EMPTY_IV, 146);
        readWzFile("TamingMob_GMS_176.wz", GameConstants.WZ_EMPTY_IV, 176);
//        readWzFile("TamingMob_GMS_230.wz", GameConstants.WZ_EMPTY_IV, 230);

        readWzFile("TamingMob_SEA_135.wz", GameConstants.WZ_EMPTY_IV, 135);
        readWzFile("TamingMob_SEA_160.wz", GameConstants.WZ_EMPTY_IV, 160);
