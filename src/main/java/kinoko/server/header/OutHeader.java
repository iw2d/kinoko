...
/**
 * Enum RecvOps, sorted by OnPacket functions in client.
 */
public enum OutHeader {
    ...
    MONSTER_CARNIVAL_RESULT_SUCCESS(349),
    MONSTER_CARNIVAL_RESULT_FAIL(350),
    MONSTER_CARNIVAL_DEATH(351),
    MONSTER_CARNIVAL_MEMBER_OUT(352),
    MONSTER_CARNIVAL_GAME_RESULT(353),

    // CField_MonsterCarnivalRevive::OnPacket
    MONSTER_CARNIVAL_REVIVE_ENTER(346),
    MONSTER_CARNIVAL_REVIVE_GAME_RESULT(353),

    // CField_AriantArena::OnPacket
    ARIANT_ARENA_SHOW_ARENA_RESULT(171),
    ARIANT_ARENA_SCORE(354),
    ...
    CASHSHOP_GACHAPON_STAMP_ITEM_RESULT(391),
    CASHSHOP_CASH_ITEM_GACHAPON_RESULT(392),
    CASHSHOP_CASH_GACHAPON_OPEN_RESULT(393),
    CHANGE_MAPLE_POINT_RESULT(394),
    CASHSHOP_ONE_A_DAY(395),
    CASHSHOP_NOTICE_FREE_CASH_ITEM(396),
    CASHSHOP_MEMBER_SHOP_RESULT(397),
