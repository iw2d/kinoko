...
if fieldId == HELIOS_TOWER_2ND_FLOOR:
    if sm.getEventState("elevator") == "ELEVATOR_2ND_FLOOR":
        sm.playPortalSE()
        ...
        sm.dispose()
elif fieldId == HELIOS_TOWER_99TH_FLOOR:
    if sm.getEventState("elevator") == "ELEVATOR_99TH_FLOOR":
        sm.playPortalSE()
